...
A machine-readable version of this reference is available at [`data_dictionary.json`](data_dictionary.json) (generated by [`scripts/generate_data_dictionary.py`](scripts/generate_data_dictionary.py)).
...
A JSON Schema for validating these files is available at [`schemas/telemetry.schema.json`](schemas/telemetry.schema.json).
