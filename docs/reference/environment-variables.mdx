...
```bash
export TIF1_CDNS='["https://cdn.staticdelivr.com/gh/TracingInsights", "https://cdn.jsdelivr.net/gh/TracingInsights"]'
```

<Info>
  Default: StaticDelivr (primary), jsDelivr (fallback)
...
[network]
cdns = ["https://cdn.staticdelivr.com/gh/TracingInsights", "https://cdn.jsdelivr.net/gh/TracingInsights"]
