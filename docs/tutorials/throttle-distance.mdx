...
<img src="/assets/throttle_distance.png" alt="Full throttle distance comparison across drivers" />
...
# All drivers, default 98% threshold
fig, ax = tif1.plot_throttle_distance(2023, 'Bahrain Grand Prix', 'Q')
plt.show()

# Stricter definition of full throttle
fig, ax = tif1.plot_throttle_distance(2023, 'Bahrain Grand Prix', 'Q', throttle_threshold=99)
plt.show()
```
...
# One call: loads qualifying and computes the full throttle share per driver
fig, ax = tif1.plot_throttle_distance(2023, 'Bahrain Grand Prix', 'Q')
plt.show()

# Or save straight to a file
# tif1.plot_throttle_distance(2023, 'Bahrain Grand Prix', 'Q', save_path="throttle_distance.png")
```
