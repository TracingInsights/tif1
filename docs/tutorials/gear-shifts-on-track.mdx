...
icon: "gears"
description: "Visualize which gear is used at each point on the circuit"
keywords:
  - "tif1"
  - "Formula 1"
  - "F1 data"
...
<img src="/assets/gear_shifts_on_track.png" alt="Gear shifts visualization on track layout" />
