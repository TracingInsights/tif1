...
# All drivers (default)
fig, ax = tif1.plot_downforce_levels(2023, 'Monaco Grand Prix', 'Q')
plt.show()

# Focus on selected drivers
fig, ax = tif1.plot_downforce_levels(2023, 'Monaco Grand Prix', 'Q', drivers=['VER', 'LEC', 'NOR'])
plt.show()
```
...
# One call: loads qualifying and computes the downforce metric per driver
fig, ax = tif1.plot_downforce_levels(2023, 'Monaco Grand Prix', 'Q')
plt.show()

# Or save straight to a file
# tif1.plot_downforce_levels(2023, 'Monaco Grand Prix', 'Q', save_path="downforce_levels.png")
```
