...
Downforce levels reveal car setup philosophy. Compare the average lap speed with the maximum speed. The ratio estimates whether a team runs a high-downforce setup (better cornering) or a low-downforce setup (higher top speeds).

<img src="/assets/downforce_levels.png" alt="Downforce levels comparison across drivers" />
