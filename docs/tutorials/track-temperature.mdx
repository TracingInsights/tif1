...
The native function accepts the shared filters. With no `drivers`, it automatically uses the driver with the most recorded laps (exactly the logic above); pass a list to draw one line per driver:
