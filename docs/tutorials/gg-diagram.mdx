...
The `smooth_derivative` / `compute_accelerations` helpers above live in the library under `tif1.charts._acceleration` and are shared with the [telemetry comparison](/tutorials/telemetry-comparison) chart.
