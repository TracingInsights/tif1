...
This tutorial shows how to create a lap-by-lap delta comparison between two drivers. The chart shows who was faster on each lap and by how much. It also shows performance trends across a race.

<img src="/assets/lap_delta.png" alt="Lap time delta comparison showing VER vs LEC at Monaco 2024" />
