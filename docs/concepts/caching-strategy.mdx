...
# Windows
C:\Users\<username>\.tif1\cache\tif1_cache.db
...
tar -czf tif1_cache.tar.gz -C ~/.tif1/cache .
...
mkdir -p ~/.tif1/cache
tar -xzf /tmp/tif1_cache.tar.gz -C ~/.tif1/cache
...
- **Optimize Performance**: Follow the [Performance Guide](/guides/performance) for optimization tips
- **Deploy to Production**: See [Deployment Guide](/guides/deployment) for production best practices
- **Monitor Cache**: Set up [Monitoring](/guides/monitoring) to track cache health
...
<CardGroup cols={3}>
  ...
  <Card title="Deployment" href="/guides/deployment" icon="server">
    Deploy tif1 with caching in production
  </Card>

  <Card title="Troubleshooting" href="/guides/troubleshooting" icon="circle-question">
