...
<Note>
Polars must be installed separately: `pip install polars>=1.36`. If Polars is not available, tif1 automatically falls back to pandas with a warning.
</Note>
...
2. Check cache directory exists: `~/.tif1/cache/`
