...
title: "Data Backends"
icon: "layer-group"
description: "pandas and polars backends in tif1: architecture, performance, API differences, and best practices"
keywords:
  - "pandas backend"
  - "polars backend"
  - "data backends"
...
**Symptom**: A polars lazy query does not return data
...
**Symptom**: Polars is not faster than pandas for the given use case
...
- [Polars User Guide](https://pola-rs.github.io/polars-book/) - Complete polars guide
