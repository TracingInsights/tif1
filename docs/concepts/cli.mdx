...
title: "CLI Tool"
icon: "terminal"
description: "Comprehensive command-line interface for tif1 - Fast F1 data access from your terminal"
keywords:
  - "tif1"
  - "Formula 1"
  - "F1 data"
...
The tif1 CLI provides a powerful command-line interface for accessing Formula 1 data directly from your terminal. Built with [Typer](https://typer.tiangolo.com/) and [Rich](https://rich.readthedocs.io/), it offers beautiful, formatted output with progress indicators and interactive tables.
...
Display detailed information about your local tif1 cache, including location, file count, and total size.
...
The tif1 cache uses SQLite with Write-Ahead Logging (WAL) for optimal performance:
...
Display the currently installed version of tif1.
...
- [Configuration](/reference/environment-variables) - Configure tif1 settings
