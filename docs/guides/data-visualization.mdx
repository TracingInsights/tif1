...
icon: "chart-line"
description: "Create F1 data visualizations with built-in charts and matplotlib"
keywords:
  - "data visualization"
  - "plotting"
  - "charts"
