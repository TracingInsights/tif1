...
# plot_speed_traces loads the session and draws both speed traces
...
# plot_driver_laptimes draws lap times per lap number for the given drivers
...
# Example data for a small custom bar chart
drivers = ["VER", "NOR", "PIA"]
values = [98, 95, 93]
team_colors = ["#3671C6", "#FF8000", "#FF8000"]
...
ver = session.get_driver("VER")
# get_fastest_lap_tel() returns the telemetry of the fastest lap
