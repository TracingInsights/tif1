...
<Info>
  ...
  - **Minification support**: Automatic `.min.json` serving
...
8. **Fallback to defaults**: If no valid sources found, uses jsDelivr as default
...
3. **Default**: `https://cdn.jsdelivr.net/gh/TracingInsights` (jsDelivr CDN)
