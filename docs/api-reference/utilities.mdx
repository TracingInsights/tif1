...
| `cdns` | `list[str]` | `["https://cdn.staticdelivr.com/gh/TracingInsights", "https://cdn.jsdelivr.net/gh/TracingInsights", "https://huggingface.co/buckets/tracinginsights"]` | List of CDN base URLs for fallback | Multiple CDNs improve reliability |
