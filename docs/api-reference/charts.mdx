...
title: "Charts API"
icon: "chart-column"
description: "22 native chart functions for Formula 1 visualization: track maps, speed traces, telemetry comparisons, lap time analysis, and performance metrics."
keywords:
  - "tif1"
  - "charts"
  - "visualization"
