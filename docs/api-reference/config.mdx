...
export TIF1_MAX_CONCURRENT_REQUESTS=22
...
export TIF1_KEEPALIVE_MAX_REQUESTS=10000
export TIF1_HTTP_RESOLVERS=standard,doh://cloudflare,doh://google
...
# Cache Configuration
export TIF1_CACHE_COMMIT_INTERVAL=100
export TIF1_SQLITE_TIMEOUT=30.0
export TIF1_MEMORY_CACHE_MAX_ITEMS=1024
export TIF1_MEMORY_TELEMETRY_CACHE_MAX_ITEMS=2048

# CDN Configuration
export TIF1_CDNS=https://cdn.jsdelivr.net/gh/TracingInsights,https://huggingface.co/buckets/tracinginsights,https://cdn.staticdelivr.com/gh/TracingInsights
...
<ResponseField name="max_concurrent_requests" type="int" default="22">
...
<ResponseField name="keepalive_max_requests" type="int" default="10000">
...
<ResponseField name="cache_commit_interval" type="int" default="100">
...
<ResponseField name="cdns" type="list[str]" default='["https://cdn.jsdelivr.net/gh/TracingInsights", "https://huggingface.co/buckets/tracinginsights", "https://cdn.staticdelivr.com/gh/TracingInsights"]'>
  List of CDN URLs to use for data fetching, in priority order (jsDelivr primary, Hugging Face buckets fallback, StaticDelivr backup). Must be HTTPS URLs.

  ```python
  config.set("cdns", ["https://cdn.jsdelivr.net/gh/TracingInsights", "https://huggingface.co/buckets/tracinginsights", "https://cdn.staticdelivr.com/gh/TracingInsights"])
  ```
</ResponseField>
...
```json
{
  ...
  "http_multiplexed": true,
  "http_disable_http3": false,
  "cdns": ["https://cdn.jsdelivr.net/gh/TracingInsights", "https://huggingface.co/buckets/tracinginsights", "https://cdn.staticdelivr.com/gh/TracingInsights"],
