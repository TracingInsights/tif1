...
Constraints:
- Never use `https://raw.githubusercontent.com` CDN (rate limits). Use jsDelivr (primary), Hugging Face buckets (fallback), or StaticDelivr (last resort) only.
